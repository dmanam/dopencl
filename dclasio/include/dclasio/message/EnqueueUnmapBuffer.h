...
/*!
 * \file EnqueueUnmapBuffer.h
 *
 * \date 2014-04-05
 * \author Philipp Kegel */

#ifndef ENQUEUEUNMAPBUFFER_H_
#define ENQUEUEUNMAPBUFFER_H_
...
class EnqueueUnmapBuffer: public Request {
public:
    EnqueueUnmapBuffer();
    EnqueueUnmapBuffer(
            ...
            bool event = false);
    EnqueueUnmapBuffer(const EnqueueUnmapBuffer& rhs);
    ...
    static const class_type TYPE = 100 + ENQUEUE_UNMAP_BUFFER;
