...
/*!
 * \file EnqueueMarker.h
 *
 * \date 2014-04-05
 * \author Philipp Kegel
 */

#ifndef ENQUEUEMARKER_H_
#define ENQUEUEMARKER_H_
...
class EnqueueMarker: public Request {
public:
    EnqueueMarker();
    EnqueueMarker(
    ...
    static const class_type TYPE = 100 + ENQUEUE_MARKER;
