...
#ifndef FLUSHREQUEST_H_
#define FLUSHREQUEST_H_
...
public:
    FlushRequest();
    FlushRequest(dcl::object_id commandQueueId);
    FlushRequest(const FlushRequest& rhs);
    virtual ~FlushRequest();

    dcl::object_id commandQueueId() const;

    static const class_type TYPE = 100 + FLUSH;
