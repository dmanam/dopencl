...
/*!
 * \file EnqueueReadBuffer.h
 *
 * \date 2014-04-05
 * \author Philipp Kegel
 */

#ifndef ENQUEUEREADBUFFER_H_
#define ENQUEUEREADBUFFER_H_
...
class EnqueueReadBuffer : public Request {
public:
    EnqueueReadBuffer();
	EnqueueReadBuffer(
    ...
    static const class_type TYPE = 100 + ENQUEUE_READ_BUFFER;
